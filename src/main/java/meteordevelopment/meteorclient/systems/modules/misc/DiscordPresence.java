...
public class DiscordPresence extends Module {
    ...
    private final Setting<List<String>> line2Strings = sgLine2.add(new StringListSetting.Builder()
        ...
        .defaultValue("IVCO on top!", "{round(server.tps, 1)} TPS", "Playing on {server.difficulty} difficulty.", "{server.player_count} Players online")
    ...
    public DiscordPresence() {
        super(Categories.Misc, "discord-presence", "Displays IVCO as your presence on Discord.");
    ...
    public void onActivate() {
        ...
        rpc.setLargeImage("novaroma", largeText);
    ...
    private void onTick(TickEvent.Post event) {
        ...
        if (Utils.canUpdate()) {
            ...
            if (!lastWasInMainMenu) {
                ...
                else if (mc.currentScreen instanceof WidgetScreen) rpc.setState("Browsing Novaroma's GUI");
    ...
    private enum SmallImage {
        MineGame("Constantiam", "constantiam.net"),
        Snail("ivco", "IVCO on top!");
